...
class ReplicationPropagationTest {
  ...
  void testCommandPropagation() throws IOException, InterruptedException {
    ...
    ByteArrayInputStream replicaInput =
    ...
    ClientHandler replicaHandler =
        new ClientHandler(replicaSocket, masterConfig, keyValuePairs, replicationService);
    ...
    ByteArrayInputStream clientInput =
        new ByteArrayInputStream(
            "*3\r\n$3\r\nSET\r\n$3\r\nfoo\r\n$3\r\nbar\r\n".getBytes(StandardCharsets.UTF_8));
    ...
    ClientHandler clientHandler =
        new ClientHandler(clientSocket, masterConfig, keyValuePairs, replicationService);
